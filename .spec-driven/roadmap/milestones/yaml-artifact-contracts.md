...
## Planned Changes
- `define-generated-artifact-schemas` - Declared: planned - define the YAML-backed field schema for generated planning artifacts, including which artifact families participate first and which fields are required, optional, or enum-constrained.
- `spec-generated-document-validation-rules` - Declared: planned - specify how malformed generated documents are reported and rejected so later CLI validation can stay deterministic.
