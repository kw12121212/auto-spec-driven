...
轻量级规范驱动开发框架：13 个 agent skills + 少量 TypeScript 脚手架。
...
中途可用 **modify** 调整任意 artifact，用 **spec-content** 只改规格内容归位，用 **sync-specs** 把现有代码行为补回规格，用 **cancel** 放弃变更。
