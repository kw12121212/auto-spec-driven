...
| 需要长期、多阶段规划 | **roadmap-plan → roadmap-milestone → roadmap-sync** | `/roadmap-plan` → `/roadmap-milestone` → `/roadmap-sync` |
...
`/roadmap-plan`、`/roadmap-milestone` 和 `/roadmap-sync` 来维护 milestone 化的 roadmap。
