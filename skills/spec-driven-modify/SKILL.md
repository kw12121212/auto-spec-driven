...
2. **Select the artifact** — run `node {{SKILL_DIR}}/scripts/spec-driven.js modify <name>` to show artifact paths. Ask the user which artifact to modify: `proposal.md`, a file in `specs/`, `design.md`, or `tasks.md`.
